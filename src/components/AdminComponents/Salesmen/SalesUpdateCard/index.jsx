...
function SalesUpdateCard({ updateSales, open, handleClose, salesValues }) {
      ...
      <Fade in={true} timeout={{ enter: 500 }}>
        <div>
          <Formik
            enableReinitialize
            initialValues={{
              value: salesValues.value,
              salesman: salesValues.salesman,
              student: salesValues.student,
              course: salesValues.course,
              upfrontValue: salesValues.upfrontValue,
              installments: salesValues.installments,
            }}
